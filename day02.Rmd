...
> Before working through this exercise, download the [SP1819.xlsx](SP1819.xlsx) and [Divisions](Divisions.csv) files into your project folder. 
...
We can also summarize columns using descriptive statistics such as the mean, minimum and maximum. Here, we'll make use of the `summarise()` function. For example:
